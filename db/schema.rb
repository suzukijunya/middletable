...
ActiveRecord::Schema.define(version: 2019_01_07_123933) do
  ...
  create_table "shop_accidents", force: :cascade do |t|
    t.integer "shop_id"
    ...
    t.index ["shop_id"], name: "index_shop_accidents_on_shop_id"
  end
